...
class GetGiftCertificateSQLBuilderTest {
    ...
    private static final String TEST_TAG_NAME = "second";

    private static final String CORRECT_BY_NAME_SQL = "SELECT * from gift_certificate gifts WHERE (gifts.name REGEXP ?) " +
            "ORDER BY gifts.name ASC";
    private static final String CORRECT_BY_TAG_NAME_SQL = "SELECT * from gift_certificate gifts " +
    ...
    private static final Object[] CORRECT_BY_NAME_ELEMENTS = new Object[]{TEST_NAME};
    private static final Object[] CORRECT_BY_TAG_NAME_ELEMENTS = new Object[]{TEST_TAG_NAME, TEST_DESCRIPTION};
